...
NGame = {
	...
	END_DATE = "2021.1.1.1",
	MAP_SCALE_PIXEL_TO_KM = 3.731,					-- Yes, we did the math
	...
	HANDS_OFF_START_TAG = "SUR",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NBuildings = {
	...
	RADAR_RANGE_BASE = 38,				-- Radar range base, first level radar will be this + min, best radar will be this + max
	RADAR_RANGE_MIN = 38,				-- Radar range (from state center to province center) in measure of map pixels. Exluding techs.
	RADAR_RANGE_MAX = 381,				-- Range is interpolated between building levels 1-15.
...
NMilitary = {
	...
	LAND_SPEED_MODIFIER = 0.095,                    -- basic speed control
...
NNavy = {
	...
	NAVAL_SPEED_MODIFIER = 0.19,	                    				-- basic speed control
	NAVAL_RANGE_TO_INGAME_DISTANCE = 0.23,							-- Scale the ship stats "naval_range" to the ingame distance
